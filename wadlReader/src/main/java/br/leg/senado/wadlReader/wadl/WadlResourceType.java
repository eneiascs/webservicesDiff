...
public class WadlResourceType {
    ...
    public WadlResourceType withId(String value) {
        setId(value);
        return this;
    }

    public WadlResourceType withDoc(WadlDoc... values) {
    ...
    public WadlResourceType withParam(WadlParam... values) {
    ...
    public WadlResourceType withMethodOrResource(Object... values) {
    ...
    public WadlResourceType withAny(Object... values) {
        for (Object value: values) {
            getAny().add(value);
        }
        return this;
